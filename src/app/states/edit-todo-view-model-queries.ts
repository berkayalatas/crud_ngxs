...
import { IPermission, ITodo, Permissions } from "../models/ITodo";
...
export class EditTodoViewModelQueries {
    ...
    static getViewModel(
        ...
        return {
            ...
            userCanEdit: permission?.permissionType === Permissions.ADMIN 
                        || permission?.permissionType === Permissions.EDITOR
        }
    }
